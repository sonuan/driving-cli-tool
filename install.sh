#!/bin/sh
# Driving CLI 安装脚本（GitHub 版本）
# 用法：curl -fsSL https://raw.githubusercontent.com/sonuan/driving-cli-tool/main/install.sh | sudo bash

set -e

BINARY_URL="https://raw.githubusercontent.com/sonuan/driving-cli-tool/main/dist/driving"
